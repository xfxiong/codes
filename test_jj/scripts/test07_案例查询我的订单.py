...
resp = requests.get(url_verify_code)
# 获取cookies
r_cookie = resp.cookies
print(r_cookie["PHPSESSID"])
# 设置cookies变量
...
resp = requests.post(url_login, data=data, cookies=cookies)
...
resp = requests.get(url=url_order, cookies=cookies)
print(resp.text)
